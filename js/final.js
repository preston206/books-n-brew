...
function insertBookAndCoffeeShopInfo() {
    ...
    $('.selected-book-url').html(`<a href="${state.selectedBook.saleInfo.buyLink}" target="_blank">https://play.google.com/store/books/</a> <img src="img/extLink.png" id="extLinkImg"/>`);
